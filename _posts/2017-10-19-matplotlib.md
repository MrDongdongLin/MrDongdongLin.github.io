---
layout: post
title: "How to plot a publication quality figure with Matplotlib?"
date: 2017-10-19 23:11:00 +0800
comments: false
category: research
tag: matplotlib
---
...
The following part of this blog will show you how to plot and improve a figure with `Matplotlib` step by step. You can download the [code](https://mrdongdonglin.github.io/codes/matplotlib_case.py) of this case.
...
![matplotlib_1](https://mrdongdonglin.github.io/images/pyplot/matplotlib_1.png)
...
# Improvement
## Axis ticks
Notice that the arrange of `t` is \\([0,50]\\), and the spacing between values is `1`, but the ticks on the figure is `10`. A more appropriate axis ticks can be set with
```python
...
![matplotlib_2](https://mrdongdonglin.github.io/images/pyplot/matplotlib_2.png)

## TeX used format
Default font of the figure is not fit with `TeX` font, if the text needs `TeX` font, the following command should be included.
```python
...
![matplotlib_3](https://mrdongdonglin.github.io/images/pyplot/matplotlib_3.png)
...
```
The purpose that setting `kwargs` `linewidth` and `color` is to make a soft vision when you put it into a `pdf` file. If you use the default color `black`, when we zoom in the `pdf`, it will be like this

![zoom-in](https://mrdongdonglin.github.io/images/pyplot/matplotlib_clear.png)

If we zoom out, guess what happend?

![zoom-out](https://mrdongdonglin.github.io/images/pyplot/matplotlib_mohu.png)

It looks sharply! So a soft vision is quite important, too.

The final version of our figure is

![matplotlib_4](https://mrdongdonglin.github.io/images/pyplot/matplotlib_4.png)